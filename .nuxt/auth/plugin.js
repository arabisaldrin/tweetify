...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/auth/token/login/","method":"post","propertyName":"auth_token"},"logout":{"url":"/auth/token/logout","method":"post"},"user":{"url":"/auth/me","method":"get","propertyName":false}},"tokenType":"Token","_name":"local"}))
